...
const AllProductsScreen: React.FC<Props> = () =>
{

    const navigation = useNavigation<NavigationProp<SearchParamList>>();
    const [filterVisible, setFilterVisible] = useState(false);
    const dispatch = useDispatch();

    // Access filtered products from Redux store
    const filteredProducts = useSelector((state: RootState) => state.products.products);
    ...
    return (
        <View style={styles.container}>
            <ScreenHeader onPress={() => navigation.goBack()} title="All Products" />
